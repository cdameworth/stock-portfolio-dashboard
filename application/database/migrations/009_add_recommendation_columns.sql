...
-- Add indexes for recommendations table (pre-existing columns only)
...
-- Note: Indexes for recommendation_outcomes, risk_level, and other new tables/columns
-- will be created in migration 011 after all tables exist
